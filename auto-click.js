...
(async () => {
  ...
  try {
    ...
    const clickList = [
      ...
      {x:1123,y:2100,name:'pos_12_1123_2100'},
      {x:770,y:1680,name:'pos_13_770_1680'},
      {x:180,y:2100,name:'pos_14_180_2100'},
      {x:300,y:2100,name:'pos_15_300_2100'},
      {x:420,y:2100,name:'pos_16_420_2100'},
      {x:540,y:2100,name:'pos_17_540_2100'},
      {x:660,y:2100,name:'pos_18_660_2100'},
      {x:780,y:2100,name:'pos_19_780_2100'},
      {x:900,y:2100,name:'pos_20_900_2100'},
      {x:1123,y:2100,name:'pos_21_1123_2100'},
      {x:770,y:1580,name:'pos_22_770_1580'}
   ];
